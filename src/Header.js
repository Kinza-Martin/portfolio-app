                    ...
                    <div className="row">
                        ...
                        <div className="col text-center text-lg-start">
                            ...
                            <ul className="list-inline">
                                <li className="list-inline-item my-2"><a href="mailto: Kinza.martin@edu.sait.ca" className="fs-5 link-light text-decoration-none"><i
                                    className="bi bi-envelope pe-1"></i>
                                    <span className="text-center">E-mail</span></a></li>
                                <li className="list-inline-item my-2"><a href="mailto: Kinza.martin@edu.sait.ca" className="fs-5 link-light text-decoration-none"><i
                                    className="bi bi-linkedin pe-1"></i>
                                    LinkedIn</a></li>
                                <li className="list-inline-item my-2"><a href="http://github.com/kinza.martin" className="fs-5 link-light text-decoration-none"><i
